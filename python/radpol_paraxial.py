...
fig1.canvas.set_window_title(unicode("Distribution du champ électrique (paraxial)"))
...
fig2.canvas.set_window_title(unicode("Densité d'énergie électrique (paraxial)"))
maxi = max(wr + wz)
rscl = r/lambda0
